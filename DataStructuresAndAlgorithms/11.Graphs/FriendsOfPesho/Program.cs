namespace Graphs
{
    ...
    // all in one for easy copy/paste in bgcoder
    ...
    public class FriendsInNeed
    {
        ...
        public static void Main()
        {
            ...
            for (int i = 0; i < streetsCount; i++)
            {
                ...
                map[points[streetInfo[0]]]
                    .Add(new Connection(points[streetInfo[1]], distance));
                map[points[streetInfo[1]]]
                    .Add(new Connection(points[streetInfo[0]], distance));
            }
        ...
        public static int GetDistanceToHomes(Point hospital)
        {
