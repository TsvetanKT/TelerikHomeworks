...
{
    class CustomAutoResizableStack<T>
    {
        ...
        public CustomAutoResizableStack()
        {
        ...
        public CustomAutoResizableStack(int capacity)
        {
            if (capacity <= 0)
            {
                throw new ArgumentOutOfRangeException("Capacity cannot be < 1!");
            }
            this.array = new T[capacity];
            this.count = 0;
