namespace FindSetOfWordsInLargeFile
{
    ...
    class FindSetOfWordsInLargeFile
    {
        ...
        private static void IncrementOccuranceCountTrie(Stopwatch sw, Trie start, MatchCollection allWords)
        {
            sw.Restart();
        ...
        private static void AddWordsForSearchInTrie(Stopwatch sw, Trie start, List<string> words)
        {
            sw.Start();
